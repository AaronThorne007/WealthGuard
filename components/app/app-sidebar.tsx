 ...
 export function AppSidebar({ className }: { className?: string }) {
   ...
   return (
     <aside
       className={cn(
         "flex h-full flex-col border-r bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60",
         className
       )}
     >
       <div className="flex h-14 items-center gap-2 px-4">
         ...
         <div className="leading-tight">
           ...
           <div className="text-xs text-muted-foreground">Budget & goals</div>
         </div>
       </div>
